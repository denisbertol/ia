...
def pack_folder(folder_path, output_script):
    ...
    ignore_files = ['pack_skills.py', 'unpack_skills.py']
    ...
    with open(output_script, 'w', encoding='utf-8') as f:
        ...
        f.write('''def unpack(target_dir='skills'):
    # Cria o diretório se não existir
    os.makedirs(target_dir, exist_ok=True)
    
    for rel_path, b64content in file_data.items():
        # Normaliza o caminho para o SO atual (Windows no seu caso do trabalho)
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(current_dir, 'unpack_skills.py')
    pack_folder(current_dir, output_file)
    print(f"Script de desempacotamento gerado com sucesso em: {output_file}")
    print("Copie o conteúdo de unpack_skills.py para o seu GitHub pessoal.")
