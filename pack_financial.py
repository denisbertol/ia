...
def pack_folder(folder_path, output_script):
    ...
    ignore_files = ['pack_financial.py', 'unpack_financial.py']
    ...
    with open(output_script, 'w', encoding='utf-8') as f:
        ...
        f.write('''def unpack(target_dir='financial-services'):
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(current_dir, 'unpack_financial.py')
    pack_folder(current_dir, output_file)
    print(f"Script de desempacotamento gerado com sucesso em: {output_file}")
    print("Copie o conteúdo de unpack_financial.py para o seu GitHub pessoal.")
